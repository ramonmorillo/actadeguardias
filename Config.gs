...
var COLS = {
  ...
  USUARIOS: {
    EMAIL: 0, NOMBRE: 1, ROL: 2, ACTIVO: 3, FECHA_ALTA: 4
  },
  PARTES: {
    ID: 0, FECHA_INICIO: 1, FECHA_FIN: 2, TIPO_PERIODO: 3,
    PROFESIONALES: 4, CREADO_POR: 5, FECHA_CREACION: 6,
    ULTIMA_MODIFICACION: 7, MODIFICADO_POR: 8, ESTADO: 9, OBSERVACIONES: 10
  },
  INCIDENCIAS: {
